...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("program_id", sa.Integer, sa.ForeignKey("programs.program_id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("course_id", sa.Integer, sa.ForeignKey("courses.course_id", ondelete="CASCADE"), nullable=False),
        sa.Column("prereq_course_id", sa.Integer, sa.ForeignKey("courses.course_id", ondelete="CASCADE"), nullable=False),
    )
    ...
    # indexes
    op.create_index("idx_courses_program_code", "courses", ["program_id", "course_code"])
